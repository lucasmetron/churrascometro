...
function capturarInf(){
    ...
    if(info[0].value == "" && info[1].value == "" && info[2].value == ""){
        ...
        resultado = "<h4>Para seu churrasco será preciso: </h4>" +"- "+resulCarne+" g de carne. "+"<br>"+ "-"+resulCerveja+" ml de Cerveja." +"<br>"+ "-"+resulRefri+" ml de Refrigerante" + "<br>"+ " <img src='./images/drooling-face-emoji.png' alt='fome' style='width: 100px;'>"
